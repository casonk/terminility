...
For `terminility`, security-sensitive reports should be handled privately by the repository owner.
...
- Do not commit local shell RC files, generated alias or state files, or machine-specific path mappings.
